...
<body>
  <!-- 0311 jung main page 메뉴막대 부분, 한섹션식 스크롤 되도록 설정 -->
   <nav class="navbar navbar-default navbar-fixed-top">
    ...
    <a href="http://70.12.115.176:8000/backstreet/main" class="navbar-brand">
      <img style="margin-top:-10px;" src="resources/images/blacklogo.png"  width="30%" ></a>            
	<br>
      <ul class="nav navbar-nav" id="mainlist"  style="padding-right: 13%; padding-left: 20%; margin-top:-20px;">  
