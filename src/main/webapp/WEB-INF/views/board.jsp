...
<br>
<button class="b_search" type="button" onclick="location.href='http://70.12.115.176:8000/backstreet/search?action=search&searchType=title&keyword=환불'">#환불</button>
<button class="b_search"  type="button" onclick="location.href='http://70.12.115.176:8000/backstreet/search?action=search&searchType=title&keyword=유료'">#유료 결제</button>
<button class="b_search"  type="button" onclick="location.href='http://70.12.115.176:8000/backstreet/search?action=search&searchType=title&keyword=홈페이지'">#홈페이지 사용</button>
<button class="b_search"  type="button" onclick="location.href='http://70.12.115.176:8000/backstreet/search?action=search&searchType=title&keyword=컨설팅'">#골목상권 컨설팅</button>
<button class="b_search"  type="button" onclick="location.href='http://70.12.115.176:8000/backstreet/search?action=search&searchType=title&keyword=골목상권'">#골목상권 분석</button>
<br>
<br>
<div id="search">
...
<!-- http://70.12.115.176:8000/backstreet/search?action=search&searchType=title&keyword=환불 -->
<%
