...
<body >
	...
	<div id="fullpage">
			...
			<br><br><br><br><br><br>
			<form action="http://70.12.115.176:8000/backstreet/trandsSearch"
				method="GET">				
				<div class="d_submit">
				...
				<c:if test="${sessionScope.code ne null}">
				&nbsp;&nbsp;
						<div ><img width="55" style="border-radius: 45%; text-align:right;" src="${sessionScope.userInfo[1]}" alt="프로필"><h5>${sessionScope.userInfo[0]}</h5></div>
					</c:if>
			</div>
			</form>	</div>
...
<!--        </a> -->
 <!--     0317 jung 두번째 아이콘 -->
       <div class="items"
            onclick="window.open('http://localhost:8000/backstreet/boardmain','howmuch','width=800,height=500,location=no,status=no,scrollbars=yes');">
      <img src="resources/images/q_2.svg"width='80%'><br><br>
      <b>자주하는 질문</b>
       </div>
 <!--     0317 jung 세번째 아이콘 -->
       <div class="items"
         onclick="window.open('http://localhost:8000/backstreet/intro','howmuch','width=800,height=500,location=no,status=no,scrollbars=yes');">
     <img src="resources/images/q_3.svg"width='80%'><br><br>
      <b>사용가이드</b>
       </div>
 <!--     0317 jung 네번째 아이콘 -->
       <div class="items"     
       onclick="window.open('http://localhost:8000/backstreet/consulting','howmuch','width=800,height=500,location=no,status=no,scrollbars=yes');">
 ...
 <!--     0317 jung 다섯번째 아이콘 -->
       <div class="items"     
       onclick="window.open('http://localhost:8000/backstreet/resources/ex_store.html','howmuch','width=800,height=500,location=no,status=no,scrollbars=yes');">
      <img src="resources/images/q_4.svg"width='80%'><br><br>
      <b>골목상권 예시</b>
       </div>
 <!--     0317 jung 여섯번째 아이콘 -->
       <div class="items"     onclick="window.open('http://localhost:8000/backstreet/resources/ex_consulting.html','howmuch','width=800,height=500,location=no,status=no,scrollbars=yes');">
     <img src="resources/images/q_5.svg"width='80%'><br><br>
      <b>컨설팅 예시</b>
       </div>       
   </div>
   
   <h3 style="text-align:center;"> 자사의 컨설팅을 받은 기업들</h3>
   <br>
