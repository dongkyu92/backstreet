...
<button class="b_search" type="button" onclick="location.href='http://70.12.115.176:8000/backstreet/trandsSearch?query=창업 방법'">#창업 방법</button>
<button class="b_search" type="button" onclick="location.href='http://70.12.115.176:8000/backstreet/trandsSearch?query=상권분석'">#상권분석</button>
<button class="b_search" type="button" onclick="location.href='http://70.12.115.176:8000/backstreet/trandsSearch?query=유니콘기업'">#유니콘기업</button>
<button class="b_search" type="button" onclick="location.href='http://70.12.115.176:8000/backstreet/trandsSearch?query=서울 맛집'">#서울 맛집</button>
<button class="b_search" type="button" onclick="location.href='http://70.12.115.176:8000/backstreet/trandsSearch?query=2020 트랜드'">#2020 트랜드</button>
</div>
<br>
